...
public class DispatcherApplicationResourceCleanerFactory
    ...
    @Override
    public ApplicationResourceCleaner createGlobalApplicationResourceCleaner(
            ComponentMainThreadExecutor mainThreadExecutor) {
        return DefaultApplicationResourceCleaner.forGloballyCleanableApplicationResources(
