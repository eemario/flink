...
public abstract class AbstractApplication implements Serializable {
    ...
    static {
        ...
        ALLOWED_TRANSITIONS.put(
                ...
                new HashSet<>(
                        Arrays.asList(ApplicationState.RUNNING, ApplicationState.CANCELLING)));
        ALLOWED_TRANSITIONS.put(
    ...
    /** All state transition methods must be called from the main method. */
    ...
    public void transitionToCancelling() {
        transitionState(ApplicationState.CANCELLING);
    }
