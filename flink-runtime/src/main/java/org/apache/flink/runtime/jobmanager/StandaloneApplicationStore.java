 ...
 *
 * <p>All operations are NoOps, because {@link ApplicationStoreEntry} instances cannot be recovered
 * in this recovery mode.
 */
public class StandaloneApplicationStore implements ApplicationStore {

    @Override
    public void start(ApplicationStore.ApplicationListener executionPlanListener) throws Exception {
        // Nothing to do
    }
    ...
    @Override
    public ApplicationStoreEntry recoverApplication(ApplicationID applicationID) {
        return null;
    }
}
