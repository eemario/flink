...
public class AbstractApplicationTest {
    ...
    @EnumSource(
            value = ApplicationState.class,
            names = {"FINISHED", "FAILING", "CANCELLING"})
    ...
    @Test
    void testTransitionFromCancelling() {
        AbstractApplication application = new MockApplication(new ApplicationID());
        application.transitionToCancelling();
    ...
    @EnumSource(
            value = ApplicationState.class,
            names = {"CREATED", "RUNNING", "CANCELLING", "FAILING", "FINISHED", "FAILED"})
    ...
    @EnumSource(
            value = ApplicationState.class,
            names = {"CREATED", "RUNNING", "CANCELLING", "FAILING", "FINISHED", "CANCELED"})
