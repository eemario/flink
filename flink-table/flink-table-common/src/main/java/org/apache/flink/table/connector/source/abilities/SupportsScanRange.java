...
/**
 * Interface for {@link ScanTableSource}s that support incremental processing.
 *
 * <p>Implementations of this interface provide the necessary functionality to configure the scan
 * range based on the start and end timestamps.
 */
@PublicEvolving
public interface SupportsScanRange {
    /**
     * Returns a new instance of {@link ScanTableSource} configured with a specific scan range. This
