...
/** Data for runtime filtering. */
@PublicEvolving
public class RuntimeFilteringData implements Serializable {
    ...
    public static boolean isEqual(RuntimeFilteringData data, RuntimeFilteringData another) {
        if (data == null) {
            return another == null;
        }
        if (another == null
