...
public class ChainingOptimizingExecutor implements Executor {
    ...
    public Pipeline createPipeline(
            PlanningResult planningResult, ReadableConfig configuration, String defaultJobName) {
        return createPipeline(
                planningResult, configuration, defaultJobName, Collections.emptyList());
    }
    ...
    public Pipeline createPipeline(
        ...
        return executor.createPipeline(
                new PlanningResult(
                        chainedTransformations,
                        planningResult.getSourceOffsets().orElse(null),
